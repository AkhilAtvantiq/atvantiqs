    ...
    <section className="relative bg-[#FFFFFF] overflow-hidden pt-50 pb-8">
      ...
      <div className="max-w-7xl px-6 md:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="max-w-xl z-10 pb-8">
          ...
          <p className="text-[#ff5443] inter text-2xl md:text-4xl mb-3">
  Redefining Tomorrow with
  
</p>
<h1 className="text-[42px] md:text-[55px] font-bold leading-tight text-[#1e1e1e] mb-6">
  AI & Machine Learning
</h1>
<p className="text-[#757575] text-[16px] leading-relaxed mb-8">
  Atvantiq leads the charge in AI-driven innovation, delivering intelligent solutions that predict, automate, and transform. Beyond AI, we specialize in comprehensive technology services designed to accelerate your business growth.
</p>
      ...
      <div className="container w-7xl mx-auto pt-6 px-16 md:px-22 pb-34 flex flex-col md:flex-row justify-center relative z-10">
        <div className="bg-white shadow-xl rounded-xl p-12 flex-1 text-left hover:shadow-2xl transition">
          ...
          <p className="text-[#969696] text-sm">
            Leverage AI to forecast trends, optimize operations, and make informed decisions with unparalleled accuracy.
          </p>
        </div>
        ...
        <div className="bg-white shadow-xl rounded-xl p-12 flex-1 text-left hover:shadow-2xl transition">
          ...
          <p className="text-[#969696] text-sm">
            Streamline processes with ML-powered automation, reducing costs and boosting efficiency across your operations.
          </p>
        </div>
        ...
        <div className="bg-white shadow-xl rounded-xl p-12 flex-1 text-left hover:shadow-2xl transition">
          ...
          <p className="text-[#969696] text-sm">
            From natural language processing to computer vision, we build tailored AI systems to meet your unique needs.
          </p>
        </div>
      </div>
    </section>
